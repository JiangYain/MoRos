...
const zhCN = {
  ...
  "settings.nav.generalDescription": "语言、快捷项、工作区与权限",
  ...
  "settings.general": "通用",
  "settings.generalDescription": "管理语言、快捷项、工作区、权限策略与运行环境。",
...
Object.assign(zhTW, {
  ...
  "settings.nav.general": "一般", "settings.nav.generalDescription": "語言、快捷項、工作區與權限",
  ...
  "settings.general": "一般", "settings.generalDescription": "管理語言、快捷項、工作區、權限策略與執行環境。",
  ...
  "sidebar.noConversations": "暫無對話", "sidebar.showMore": "顯示更多", "sidebar.empty": "開始第一次驗配對話後，對話會自動歸入客戶檔案。",
...
Object.assign(en, {
  ...
  "sidebar.noConversations": "No conversations", "sidebar.showMore": "Show More", "sidebar.empty": "Conversations are filed into client profiles after your first fitting conversation.",
  ...
  "settings.nav.generalDescription": "Language, shortcuts, workspace, and permissions", "settings.nav.profile": "Profile",
  ...
  "settings.generalDescription": "Manage language, shortcuts, workspace, permissions, and runtime requirements.", "settings.appearance": "Appearance",
...
Object.assign(de, {
  ...
  "sidebar.newConversationFor": "Neue Unterhaltung für {name}", "sidebar.noConversations": "Keine Unterhaltungen", "sidebar.showMore": "Mehr anzeigen",
  ...
  "settings.navigation": "Einstellungsnavigation", "settings.nav.general": "Allgemein", "settings.nav.generalDescription": "Sprache, Kurzbefehle, Arbeitsbereich und Berechtigungen",
  ...
  "settings.generalDescription": "Sprache, Kurzbefehle, Arbeitsbereich, Berechtigungen und Laufzeit verwalten.", "settings.appearance": "Darstellung",
