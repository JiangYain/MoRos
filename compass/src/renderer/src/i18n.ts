...
const zhCN = {
  ...
  "thread.dependency.phonakDescription": "客户档案包含 Phonak 助听器，但当前没有检测到 Target。需要现在下载并打开安装程序吗？",
  "thread.dependency.later": "稍后",
  "thread.dependency.install": "下载并安装 Target",
  "thread.dependency.progressTitle": "正在准备 Phonak Target",
...
Object.assign(zhTW, {
  ...
  "settings.restoreQuickPromptDefaults": "恢復預設",
  ...
  "settings.dependency.targetSelectionUnavailable": "先前選擇的 Target.exe 已無法使用，請重新選擇或恢復自動選擇。",
  ...
  "settings.dependency.targetResetExecutable": "恢復自動選擇",
  ...
  "sidebar.noConversations": "暫無對話", "sidebar.showMore": "顯示更多", "sidebar.showLess": "收起", "sidebar.empty": "開始第一次驗配對話後，對話會自動歸入客戶檔案。",
...
Object.assign(en, {
  ...
  "composer.segment.conversation": "Conversation", "composer.effort": "Effort",
  ...
  "thread.dependency.phonakDescription": "The client profile includes Phonak hearing aids, but Target was not detected. Download and open the installer now?",
  "thread.dependency.later": "Later", "thread.dependency.install": "Download & install Target",
  "thread.dependency.progressTitle": "Preparing Phonak Target", "thread.dependency.downloaded": "{downloaded} downloaded{total}",
...
Object.assign(de, {
  ...
  "composer.segment.conversation": "Unterhaltung", "composer.effort": "Denktiefe",
  ...
  "thread.dependency.phonakDescription": "Das Kundenprofil enthält Phonak-Hörgeräte, Target wurde jedoch nicht erkannt. Jetzt herunterladen und den Installer öffnen?",
  "thread.dependency.later": "Später", "thread.dependency.install": "Target herunterladen & installieren",
  "thread.dependency.progressTitle": "Phonak Target wird vorbereitet", "thread.dependency.downloaded": "{downloaded} heruntergeladen{total}",
