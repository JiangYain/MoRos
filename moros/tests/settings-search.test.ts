...
const TARGETS: readonly SettingsSearchTarget[] = [
  ...
  },
  {
    ...
    title: "Appearance",
    description: "Control how Moros looks and feels.",
  ...
  },
  {
    ...
    title: "Skills",
    description: "Manage the skills available to Moros.",
  ...
  },
  {
    ...
    title: "Language",
    description: "Choose the language used by the Moros interface.",
...
test("results keep the declared order so navigation is stable", () => {
  // "moros" appears in both page-level and setting-level descriptions. Every
  // result should stay in the order declared in TARGETS.
  const matches = filterSettingsTargets(TARGETS, "moros");
  assert.deepEqual(
