...
const zhCN = {
  ...
  "settings.skillsDescription": "管理 Moros 可以调用的本地技能与额外技能目录。",
...
const zhTW = {
  ...
  "settings.skillsDescription": "管理 Moros 可呼叫的本機技能與其他技能目錄。",
...
const en = {
  ...
  "settings.context": "{value} context", "settings.skillsEyebrow": "Agent capabilities", "settings.skillsDescription": "Manage local skills and additional skill folders Moros can use.",
