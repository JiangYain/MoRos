...
import { createMorosCommandActions } from "./store/commands";
import {
  loadProfileAvatar,
  loadProfileIdentity,
...
export const useMoros = create<MorosState>((set, get) => {
  ...
  seedComposer: (text, images) => set({ composerSeed: { text, images }, settingsSection: null }),
